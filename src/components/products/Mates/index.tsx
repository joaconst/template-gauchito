...
const Mates = () => {
    ...
    const cards = [
        { title: "Mates Vírgenes", img: "products/mates/mate-1.webp", alt: "Mate artesanal 1" },
        { title: "Mates Lijados y Barnizados", img: "products/mates/mate-2.webp", alt: "Mate artesanal 2" },
        { title: "Mates Pintados", img: "products/mates/mate-3.webp", alt: "Mate artesanal 3" },
        { title: "Mates Grabados", img: "products/mates/mate-4.webp", alt: "Mate artesanal 4" },
    ];
    ...
    return (
        <section className="bg-secondary py-6">
            ...
            {/* Remover px-4 en desktop usando clases responsivas */}
                ...
                >
                    {cards.map((card, index) => (
                        <SwiperSlide key={index} className="p-4">
                            <div className="bg-background-secondary h-[60vh] rounded-2xl hover:scale-105 hover:ring-2 hover:ring-primary transition-all duration-300">
                                <img
                                    src={card.img}
                                    alt={card.alt}
