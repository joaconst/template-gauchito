...
const Platos = () => {
    ...
    const cards = [
        { title: "Platos Vírgenes", img: "products/platos/plato-1.webp", alt: "Plato artesanal 1" },
        { title: "Platos Lijados y Barnizados", img: "products/platos/plato-2.webp", alt: "Plato artesanal 2" },
        { title: "Platos Pintados", img: "products/platos/plato-3.webp", alt: "Plato artesanal 3" },
        { title: "Platos Grabados", img: "products/platos/plato-4.webp", alt: "Plato artesanal 4" },
    ];

    return (
        <section className="bg-tertiary py-6 mt-16">
            <h2 className="text-3xl font-bold text-center mb-4 mt-4">Platos</h2>
